...
Public Class VEN_NOTACREDITO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.VEN_NOTACREDITO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVEN_NOTACREDITO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VEN_NOTACREDITO = New VEN_NOTACREDITO
        rpt.Site = Me.Site
        Return rpt
    End Function
