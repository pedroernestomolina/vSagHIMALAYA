...
'     Versión del motor en tiempo de ejecución:2.0.50727.8789
'
...
Public Class HABLADOR_MED_2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.HABLADOR_MED_2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHABLADOR_MED_2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HABLADOR_MED_2 = New HABLADOR_MED_2
        rpt.Site = Me.Site
        Return rpt
    End Function
