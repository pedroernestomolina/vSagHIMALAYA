...
Public Class rep_compra_gasto
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.rep_compra_gasto.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_compra_gasto
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_compra_gasto = New rep_compra_gasto
        rpt.Site = Me.Site
        Return rpt
    End Function
