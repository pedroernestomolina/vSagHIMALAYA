...
Public Class PROVEEDOR_FICHA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.PROVEEDOR_FICHA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPROVEEDOR_FICHA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PROVEEDOR_FICHA = New PROVEEDOR_FICHA
        rpt.Site = Me.Site
        Return rpt
    End Function
