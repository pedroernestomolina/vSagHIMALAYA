...
Public Class RET_VENTAS_FECHA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.RET_VENTAS_FECHA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRET_VENTAS_FECHA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RET_VENTAS_FECHA = New RET_VENTAS_FECHA
        rpt.Site = Me.Site
        Return rpt
    End Function
