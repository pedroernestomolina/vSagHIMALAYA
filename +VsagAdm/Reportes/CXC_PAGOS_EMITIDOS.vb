...
Public Class CXC_PAGOS_EMITIDOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CXC_PAGOS_EMITIDOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCXC_PAGOS_EMITIDOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CXC_PAGOS_EMITIDOS = New CXC_PAGOS_EMITIDOS
        rpt.Site = Me.Site
        Return rpt
    End Function
