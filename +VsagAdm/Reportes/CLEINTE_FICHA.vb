...
Public Class CLEINTE_FICHA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CLEINTE_FICHA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCLEINTE_FICHA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CLEINTE_FICHA = New CLEINTE_FICHA
        rpt.Site = Me.Site
        Return rpt
    End Function
