...
Public Class VEN_CONSOLIDADO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.VEN_CONSOLIDADO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVEN_CONSOLIDADO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VEN_CONSOLIDADO = New VEN_CONSOLIDADO
        rpt.Site = Me.Site
        Return rpt
    End Function
