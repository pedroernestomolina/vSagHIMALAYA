...
Public Class FACTURAS_COBRANZA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.FACTURAS_COBRANZA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFACTURAS_COBRANZA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FACTURAS_COBRANZA = New FACTURAS_COBRANZA
        rpt.Site = Me.Site
        Return rpt
    End Function
