...
Public Class GUIA_DESPACHO_XX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.GUIA_DESPACHO_XX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGUIA_DESPACHO_XX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GUIA_DESPACHO_XX = New GUIA_DESPACHO_XX
        rpt.Site = Me.Site
        Return rpt
    End Function
