...
Public Class CLIENTE_ESTADO_CUENTA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CLIENTE_ESTADO_CUENTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CLIENTE_ESTADO_CUENTA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_SALDO_ANTERIOR() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCLIENTE_ESTADO_CUENTA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CLIENTE_ESTADO_CUENTA = New CLIENTE_ESTADO_CUENTA
        rpt.Site = Me.Site
        Return rpt
    End Function
