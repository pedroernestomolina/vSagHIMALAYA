...
Public Class CXP_DOCUMENTOS_PENDIENTES
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CXP_DOCUMENTOS_PENDIENTES.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CXP_DOCUMENTOS_PENDIENTES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCXP_DOCUMENTOS_PENDIENTES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CXP_DOCUMENTOS_PENDIENTES = New CXP_DOCUMENTOS_PENDIENTES
        rpt.Site = Me.Site
        Return rpt
    End Function
