...
Public Class RPT_LIBRO_COMPRAS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.RPT_LIBRO_COMPRAS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPT_LIBRO_COMPRAS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_LIBRO_COMPRAS = New RPT_LIBRO_COMPRAS
        rpt.Site = Me.Site
        Return rpt
    End Function
