...
Public Class CXP_ANALISIS_VENCIMIENTO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CXP_ANALISIS_VENCIMIENTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CXP_ANALISIS_VENCIMIENTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCXP_ANALISIS_VENCIMIENTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CXP_ANALISIS_VENCIMIENTO = New CXP_ANALISIS_VENCIMIENTO
        rpt.Site = Me.Site
        Return rpt
    End Function
