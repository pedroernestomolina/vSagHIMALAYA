...
Public Class VEN_DEPARTAMENTO_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.VEN_DEPARTAMENTO_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVEN_DEPARTAMENTO_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VEN_DEPARTAMENTO_1 = New VEN_DEPARTAMENTO_1
        rpt.Site = Me.Site
        Return rpt
    End Function
