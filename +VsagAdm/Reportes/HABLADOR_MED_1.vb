...
Public Class HABLADOR_MED_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.HABLADOR_MED_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHABLADOR_MED_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HABLADOR_MED_1 = New HABLADOR_MED_1
        rpt.Site = Me.Site
        Return rpt
    End Function
