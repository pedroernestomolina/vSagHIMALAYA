...
Public Class TarjetaAfiliacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.TarjetaAfiliacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTarjetaAfiliacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TarjetaAfiliacion = New TarjetaAfiliacion
        rpt.Site = Me.Site
        Return rpt
    End Function
