Public Class GenDetalle
    ...
    Property idItemTemp As String
    Property provDocOrigen As Boolean
    ReadOnly Property montoBase As Decimal
        Get
            Dim rt = 0D
            If tasaIva > 0 Then
                rt = precioFinal * cantidad
            End If
            Return rt
        End Get
    End Property
    ReadOnly Property montoImpuesto As Decimal
        Get
            Dim rt = 0D
            If tasaIva > 0 Then
        ...
        End Get
    End Property
    ReadOnly Property montoExento As Decimal
        Get
            Dim rt = 0D
            If tasaIva = 0 Then
                rt = precioFinal * cantidad
        ...
        End Get
    End Property
    ReadOnly Property importeNeto As Decimal
        Get
            Dim rt = 0D
            rt = precioItem * cantidad
            Return rt
        End Get
    End Property
