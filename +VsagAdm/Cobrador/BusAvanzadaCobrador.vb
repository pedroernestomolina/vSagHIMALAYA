Public Class BusAvanzadaCobrador
    ...
    Private Sub BusAvanzadaCobrador_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
    ...
    Private Sub BusAvanzadaCobrador_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Escape) Then
            Me.Close()
        End If
    End Sub

    Private Sub BusAvanzadaCobrador_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Inicializa()
    End Sub
    ...
    Private Sub BusAvanzadaCobrador_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        EstatusSalida = False
    End Sub
    ...
    Private Sub BT_PROCESAR_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BT_PROCESAR.Click
        ...
        Try
            ...
            Dim xsql As String = "select nombre nom, telefono1 tel, celular1 cel, * from cobradores where auto<>'' "
