...
Public Class FichaVendedor
    ...
    Dim xfichaven As FichaVendedores
    Dim xtb_comisiones As DataTable
    Dim xvendedorauto As String

    'PARA BUSQUEDA DE VENDEDORES RAPIDAS
    Const Busqueda_1 As String = "select nombre nom, telefono1 tel, celular1 cel, * from vendedores where nombre like @data order by nombre"
    Const Busqueda_2 As String = "select nombre nom, telefono1 tel, celular1 cel, * from vendedores where ci like @data order by ci"
    Const Busqueda_3 As String = "select nombre nom, telefono1 tel, celular1 cel, * from vendedores where codigo like @data order by codigo"

    Property _AutoVendedorCargar() As String
        Get
            Return xvendedorauto
        End Get
    ...
    Private Sub FichaVendedor_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        Else
            If MiFichaAccion = TipoAccionFicha.Adicionar Or MiFichaAccion = TipoAccionFicha.Consultar Then
                If MessageBox.Show("Deseas Cerrar Esta Ficha De Vendedor y/o Perder Los Datos ?", "*** MENSAJE DE ALERTA ***", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
            ...
            ElseIf MiFichaAccion = TipoAccionFicha.Modificar Then
                If MessageBox.Show("Deseas Cerrar Esta Ficha De Vendedor y/o Perder Los Datos ?", "*** MENSAJE DE ALERTA ***", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                    VendedorNuevoRegistrado(xfichaven.f_Vendedor.RegistroDato.r_Automatico)
                    e.Cancel = True
                Else
                    e.Cancel = True
                End If
    ...
    Private Sub FichaVendedor_KeyDown(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub FichaVendedor_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles Me.KeyPress
        If e.KeyChar = Chr(Keys.Escape) Then
            Me.Close()
        End If
    End Sub

    Private Sub FichaVendedor_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        pb_tm = PB_1.Size
    End Sub
    ...
    Sub InicializarControles()
        ...
        With Me.MT_RIF
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_CiRif.c_Largo
            .Enabled = op
        End With
        With Me.MT_CODIGO
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Comentarios.c_Largo
            .Enabled = op
        End With
        With Me.MT_NOMBRE
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_NombreVendedor.c_Largo
            .Enabled = op
        End With
        With Me.MT_DIRECCION
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Direccion.c_Largo
            .Enabled = op
        End With
        With Me.MT_CONTACTO
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_ContactarA.c_Largo
            .Enabled = op
        End With
        With Me.MT_EMAIL
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Email.c_Largo
            .Enabled = op
        End With
        With Me.MT_CEL1
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Celular_1.c_Largo
            .Enabled = op
        End With
        With Me.MT_CEL2
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Celular_2.c_Largo
            .Enabled = op
        End With
        With Me.MT_FAX1
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Fax_1.c_Largo
            .Enabled = op
        End With
        With Me.MT_FAX2
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Fax_2.c_Largo
            .Enabled = op
        End With
        With Me.MT_TEL1
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Telefono_1.c_Largo
            .Enabled = op
        End With
        With Me.MT_TEL2
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Telefono_2.c_Largo
            .Enabled = op
        End With
        ...
        With Me.MT_ADVERTENCIA
            .Text = ""
            .MaxLength = xfichaven.f_Vendedor.RegistroDato.c_Advertencia.c_Largo
            .Enabled = op
        End With
        ...
        With Me.MCB_BUSQUEDA
            .DataSource = xfichaven.f_Vendedor.p_TipoBusqueda
            .SelectedIndex = g_MiData.f_FichaGlobal.f_ConfSistema.cnf_BuscarVendedor
        End With
    ...
    Sub ActivarDesactivarControles(ByVal op As Encendido)
        ...
        If MiFichaAccion = TipoAccionFicha.Modificar Or MiFichaAccion = TipoAccionFicha.Consultar Or MiFichaAccion = TipoAccionFicha.Inactivo Then
            If Me.xfichaven.f_Vendedor.RegistroDato.r_EstatusFoto Then
    ...
    Sub Inicializa()
        Try
            xfichaven = New DataSistema.MiDataSistema.DataSistema.FichaVendedores
            AddHandler xfichaven.VendedorNuevo, AddressOf VendedorNuevoRegistrado
            ...
            If _AutoVendedorCargar <> "" Then
                VendedorNuevoRegistrado(_AutoVendedorCargar)
            End If
    ...
    Private Sub FichaVendedor_Shown(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Shown
        Inicializa()
    End Sub
    ...
    Sub CargarCombos()
        With Me.MCB_TIPO_COMISION
            .DataSource = xfichaven.f_Vendedor.p_TipoComsion
            If MiFichaAccion = TipoAccionFicha.Adicionar Then
                .SelectedIndex = 0
            End If
        End With
    ...
    Sub BusquedaVendedores()
        If MT_BUSCAR.r_Valor <> "" Then
            Dim xsql As String = ""
            Dim xp1 As SqlParameter
            Dim xbuscar As String = ""

            Select Case CType(Me.MCB_BUSQUEDA.SelectedIndex, FichaVendedores.TipoBusquedaVendedor)
                Case FichaVendedores.TipoBusquedaVendedor.PorNombre
                    xsql = Busqueda_1
                Case FichaVendedores.TipoBusquedaVendedor.PorRif_CI
                    xsql = Busqueda_2
                Case FichaVendedores.TipoBusquedaVendedor.PorCodigo
                    xsql = Busqueda_3
            End Select
            ...
            Dim xficha As New Plantilla_2(New BusquedaVendedor, xsql, xp1)
            With xficha
                AddHandler .EnviarAuto, AddressOf VendedorNuevoRegistrado
                .ShowDialog()
            End With
            Me.MT_BUSCAR.Text = ""
        End If
    ...
    Sub VendedorNuevoRegistrado(ByVal xauto As String)
        Try
            xfichaven.F_BuscarVendedor(xauto)
            MostrarData()
            If MiFichaAccion = TipoAccionFicha.Adicionar Then
                MessageBox.Show("Vendedor Registrado Con Exito...", "*** Mensaje De Exito ***", MessageBoxButtons.OK, MessageBoxIcon.Information)
            End If
    ...
    Sub MostrarData()
        ...
        Me.MT_CODIGO.Text = xfichaven.f_Vendedor.RegistroDato.r_CodigoVendedor
        Me.MT_RIF.Text = xfichaven.f_Vendedor.RegistroDato.r_CiRif
        Me.MT_NOMBRE.Text = xfichaven.f_Vendedor.RegistroDato.r_NombreVendedor
        Me.MT_DIRECCION.Text = xfichaven.f_Vendedor.RegistroDato.r_DireccionVendedor
        Me.MT_CONTACTO.Text = xfichaven.f_Vendedor.RegistroDato.r_ContactarA
        Me.MT_TEL1.Text = xfichaven.f_Vendedor.RegistroDato.r_Telefono_1
        Me.MT_TEL2.Text = xfichaven.f_Vendedor.RegistroDato.r_Telefono_2
        Me.MT_FAX1.Text = xfichaven.f_Vendedor.RegistroDato.r_Fax_1
        Me.MT_FAX2.Text = xfichaven.f_Vendedor.RegistroDato.r_Fax_2
        Me.MT_CEL1.Text = xfichaven.f_Vendedor.RegistroDato.r_Celular_1
        Me.MT_CEL2.Text = xfichaven.f_Vendedor.RegistroDato.r_Celular_2
        Me.MT_EMAIL.Text = xfichaven.f_Vendedor.RegistroDato.r_Email
        Me.MN_COMISION.Text = String.Format("{0:#0.00}", xfichaven.f_Vendedor.RegistroDato.r_ComisionPersonalizada)
        Me.MCB_TIPO_COMISION.SelectedIndex = xfichaven.f_Vendedor.RegistroDato.r_TipoComisionAsignada
        CargarTipoComision()

        Me.E_FECHA_REG.Visible = True
        Me.E_FECHA_REGISTRO.Visible = True
        Me.E_FECHA_REGISTRO.Text = xfichaven.f_Vendedor.RegistroDato.r_FechaCreacion.ToShortDateString

        If xfichaven.f_Vendedor.RegistroDato.r_EstatusVendedor = TipoEstatus.Activo Then
            Me.PB_ESTATUS.Image = My.Resources.ClienteActivo_1
        Else
            Me.PB_ESTATUS.Image = My.Resources.Inactivo_1
        End If

        Me.MT_ADVERTENCIA.Text = xfichaven.f_Vendedor.RegistroDato.c_Advertencia.c_Texto
        Me.MT_COMENTARIOS.Text = xfichaven.f_Vendedor.RegistroDato.c_Comentarios.c_Texto
    End Sub
    ...
    Sub BusquedaAvanzada()
        Dim xficha As New BusAvanzadaVendedor
        With xficha
    ...
    Sub ReceptorBusAvanzada(ByVal xsql As String)
        Dim xficha As New Plantilla_2(New BusquedaVendedor, xsql)
        With xficha
            AddHandler .EnviarAuto, AddressOf VendedorNuevoRegistrado
            .ShowDialog()
        End With
    ...
    Sub AgregarVendedor()
        Try
            If MiFichaAccion = TipoAccionFicha.Consultar Or MiFichaAccion = TipoAccionFicha.Inactivo Then
                g_MiData.f_FichaGlobal.f_PermisosUsuario.op_ModuloVendedor_Ingresar.F_Permitir()
                Try
                    MiFichaAccion = TipoAccionFicha.Adicionar
                    xfichaven.f_Vendedor.RegistroDato.M_LimpiarRegistro()
                Catch ex As Exception
    ...
    Sub CargarTipoComision()
        Select Case CType(MCB_TIPO_COMISION.SelectedIndex, FichaVendedores.TipoComisionVendedor)
            Case FichaVendedores.TipoComisionVendedor.SinComision
                xtb_comisiones.Rows.Clear()
                Me.MN_COMISION.Text = "0.0"
                Me.MN_COMISION.ReadOnly = True
            Case FichaVendedores.TipoComisionVendedor.ComisionGlobal
                xtb_comisiones.Rows.Clear()
                Me.MN_COMISION.Text = String.Format("{0:#0.00}", g_MiData.f_FichaGlobal.f_ConfSistema.cnf_ModuloVendedor._ComisionGlobalAsignada)
                Me.MN_COMISION.ReadOnly = True
            Case FichaVendedores.TipoComisionVendedor.ComisionRango
                CargarTablaVendedores()
                Me.MN_COMISION.Text = "0.0"
                Me.MN_COMISION.ReadOnly = True
            Case FichaVendedores.TipoComisionVendedor.ComisionPersonalizada
                xtb_comisiones.Rows.Clear()
                Me.MN_COMISION.Text = String.Format("{0:#0.00}", xfichaven.f_Vendedor.RegistroDato.r_ComisionPersonalizada)
    ...
    Sub CargarTablaVendedores()
        Try
            g_MiData.F_GetData("select desde,hasta,comision from comisionrango_vendcob where tipo='V' order by desde ", xtb_comisiones)
            With Me.MisGrid1
        ...
        If VerificarVendedor() Then
            Try
                ...
                If MessageBox.Show(xms, "*** Mensaje De Alerta ***", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                    If MiFichaAccion = TipoAccionFicha.Adicionar Then
                        Dim xvendedor As New FichaVendedores.c_Vendedor.c_AgregarVendedor
                        ...
                        End With
                        xfichaven.F_VendedorNuevo(xvendedor)
                    End If

                    If MiFichaAccion = TipoAccionFicha.Modificar Then
                        With xRegModificar
                            ._Adevertencia = Me.MT_ADVERTENCIA.r_Valor
                            ._Automatico = xfichaven.f_Vendedor.RegistroDato.r_Automatico
                            ._Celular_1 = Me.MT_CEL1.r_Valor
                            ._Celular_2 = Me.MT_CEL2.r_Valor
                            ._CiRif = Me.MT_RIF.r_Valor
                            ._Codigo = Me.MT_CODIGO.r_Valor
                            ...
                            ._Fax_1 = Me.MT_FAX1.r_Valor
                            ._Fax_2 = Me.MT_FAX2.r_Valor
                            ._IdSeguridad = xfichaven.f_Vendedor.RegistroDato.r_IdSeguridad
                            ._Nombre = Me.MT_NOMBRE.r_Valor
                            ._PersonaContacto = Me.MT_CONTACTO.r_Valor
                            ._Telefono_1 = Me.MT_TEL1.r_Valor
                            ._Telefono_2 = Me.MT_TEL2.r_Valor
                            ...
                            ._Comision = Me.MN_COMISION._Valor
                        End With
                        xfichaven.F_VendedorModifica(xRegModificar)
                    End If
    ...
    Function VerificarVendedor() As Boolean
    ...
    Sub EliminarVendedor()
        Try
            If MiFichaAccion = TipoAccionFicha.Consultar Then
                If xfichaven.f_Vendedor.RegistroDato.r_Automatico <> "" Then
                    g_MiData.f_FichaGlobal.f_PermisosUsuario.op_ModuloVendedor_Eliminar.F_Permitir()

                    Try
                        If MessageBox.Show("Estas Seguro De Eliminar Esta Ficha De Vendedor ?", "*** Mensaje De Alerta ***", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) = Windows.Forms.DialogResult.Yes Then
                            If xfichaven.F_VendedorElimina(xfichaven.f_Vendedor.RegistroDato.r_Automatico) Then
                                RaiseEvent ActualizarFicha()
                                MessageBox.Show("Vendedor Eliminado Con Exito...", "*** Mensaje De Exito ***", MessageBoxButtons.OK, MessageBoxIcon.Information)
                                MiFichaAccion = TipoAccionFicha.Inactivo
                            End If
                        End If
                    Catch ex As Exception
    ...
    Dim xRegModificar As FichaVendedores.c_Vendedor.c_ModificarVendedor
    Sub ModificarVendedor()
        Try
            If MiFichaAccion = TipoAccionFicha.Consultar Then
                If xfichaven.f_Vendedor.RegistroDato.r_Automatico <> "" Then
                    g_MiData.f_FichaGlobal.f_PermisosUsuario.op_ModuloVendedor_Modificar.F_Permitir()

                    xRegModificar = New FichaVendedores.c_Vendedor.c_ModificarVendedor
                    xRegModificar._Estatus = xfichaven.f_Vendedor.RegistroDato.r_EstatusVendedor
