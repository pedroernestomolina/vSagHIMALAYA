...
Public Class RPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "RPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.RPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_NombreEmpresa() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_RifEmpresa() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_MaquinaRegistradora() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedRPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA = New RPT_VENTAS_DETALLE_CONTR_AGRP_FECH_MAQUINA
        rpt.Site = Me.Site
        Return rpt
    End Function
