...
Public Class VEN_DEPARTAMENTO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.VEN_DEPARTAMENTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVEN_DEPARTAMENTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VEN_DEPARTAMENTO = New VEN_DEPARTAMENTO
        rpt.Site = Me.Site
        Return rpt
    End Function
