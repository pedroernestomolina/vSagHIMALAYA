...
Public Class CXC_RELACION_COBRANZA
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CXC_RELACION_COBRANZA.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CXC_RELACION_COBRANZA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCXC_RELACION_COBRANZA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CXC_RELACION_COBRANZA = New CXC_RELACION_COBRANZA
        rpt.Site = Me.Site
        Return rpt
    End Function
