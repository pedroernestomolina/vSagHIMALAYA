...
Public Class rep_cxp_recibo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.rep_cxp_recibo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_cxp_recibo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_cxp_recibo = New rep_cxp_recibo
        rpt.Site = Me.Site
        Return rpt
    End Function
