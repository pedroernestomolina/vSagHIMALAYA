...
Public Class rep_cxc_recibo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.rep_cxc_recibo.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rep_modos_pagorpt_NOMBRE() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_rep_modos_pagorpt_IMPORTE() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class Cachedrep_cxc_recibo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_cxc_recibo = New rep_cxc_recibo
        rpt.Site = Me.Site
        Return rpt
    End Function
