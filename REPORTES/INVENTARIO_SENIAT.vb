...
Public Class INVENTARIO_SENIAT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.INVENTARIO_SENIAT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINVENTARIO_SENIAT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INVENTARIO_SENIAT = New INVENTARIO_SENIAT
        rpt.Site = Me.Site
        Return rpt
    End Function
