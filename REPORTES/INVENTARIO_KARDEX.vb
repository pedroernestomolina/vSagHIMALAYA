...
Public Class INVENTARIO_KARDEX
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.INVENTARIO_KARDEX.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINVENTARIO_KARDEX
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INVENTARIO_KARDEX = New INVENTARIO_KARDEX
        rpt.Site = Me.Site
        Return rpt
    End Function
