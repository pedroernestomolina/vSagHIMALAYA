...
Public Class CXP_PAGOS_EMITIDOS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CXP_PAGOS_EMITIDOS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCXP_PAGOS_EMITIDOS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CXP_PAGOS_EMITIDOS = New CXP_PAGOS_EMITIDOS
        rpt.Site = Me.Site
        Return rpt
    End Function
