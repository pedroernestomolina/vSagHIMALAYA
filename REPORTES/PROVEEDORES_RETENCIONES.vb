...
Public Class PROVEEDORES_RETENCIONES
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "PROVEEDORES_RETENCIONES.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.PROVEEDORES_RETENCIONES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPROVEEDORES_RETENCIONES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PROVEEDORES_RETENCIONES = New PROVEEDORES_RETENCIONES
        rpt.Site = Me.Site
        Return rpt
    End Function
