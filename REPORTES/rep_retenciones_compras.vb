...
Public Class rep_retenciones_compras
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rep_retenciones_compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.rep_retenciones_compras.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_retenciones_compras
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_retenciones_compras = New rep_retenciones_compras
        rpt.Site = Me.Site
        Return rpt
    End Function
