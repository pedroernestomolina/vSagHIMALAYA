...
Public Class VEN_PORGRUPO_1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.VEN_PORGRUPO_1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedVEN_PORGRUPO_1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As VEN_PORGRUPO_1 = New VEN_PORGRUPO_1
        rpt.Site = Me.Site
        Return rpt
    End Function
