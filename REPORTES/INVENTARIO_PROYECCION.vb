...
Public Class INVENTARIO_PROYECCION
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "INVENTARIO_PROYECCION.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.INVENTARIO_PROYECCION.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedINVENTARIO_PROYECCION
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As INVENTARIO_PROYECCION = New INVENTARIO_PROYECCION
        rpt.Site = Me.Site
        Return rpt
    End Function
