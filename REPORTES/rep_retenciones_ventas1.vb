...
Public Class rep_retenciones_ventas
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rep_retenciones_ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.rep_retenciones_ventas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrep_retenciones_ventas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rep_retenciones_ventas = New rep_retenciones_ventas
        rpt.Site = Me.Site
        Return rpt
    End Function
