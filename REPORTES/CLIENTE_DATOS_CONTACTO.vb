...
Public Class CLIENTE_DATOS_CONTACTO
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CLIENTE_DATOS_CONTACTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "_VsagAdm.CLIENTE_DATOS_CONTACTO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCLIENTE_DATOS_CONTACTO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CLIENTE_DATOS_CONTACTO = New CLIENTE_DATOS_CONTACTO
        rpt.Site = Me.Site
        Return rpt
    End Function
